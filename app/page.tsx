          ...
          <div className="grid grid-cols-1 landscape:grid-cols-2 gap-3">
            {courts.map(court => (
              ...
              >
                ...
                {/* 修正箇所: 割当ボタン時も中身を100%に広げ、試合中と同じ余白(p-3)を確保 */}
                <div className="flex-1 p-3 flex flex-col justify-center h-full overflow-hidden">
                  {court.match ? (
                    ...
                    /* 修正箇所: w-full h-full を付与してコンテナいっぱいに広がるように設定 */
